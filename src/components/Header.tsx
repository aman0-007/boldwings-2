      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-3">
            ...
            } transition-colors duration-300`}>BoldWings</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {[
              ...
              { name: 'Life at BoldWings', path: '/life' },
              ...
              <Link
                ...
                className={`relative font-medium text-sm uppercase tracking-wider ${
                  isScrolled || !isHomePage ? 'text-gray-700 hover:text-[#f9df54]' : 'text-white hover:text-[#f9df54]'
                } transition-colors duration-300 ${
                  location.pathname === item.path ? 'after:content-[""] after:absolute after:-bottom-2 after:left-0 after:w-full after:h-0.5 after:bg-[#f9df54]' : ''
                }`}
              >
                {item.name}
              </Link>
